# lab task 5 question 2
# Q2: Implement a circular queue in Python. Include methods for enqueue, dequeue,
# checking if the queue is empty, checking if the queue is full, and finding the size of the queue.
